<?php
    ...
    if($_POST) {
    	try {
	    	...
	    	$db_f = new Forum();
	    	$res_f = $db_f->CreateNewsForum($discusion, $_SESSION['UserId'], $message, $id_ruang);
	   		if($res_f) {
                echo "<script type=\"text/javascript\">
                                alert(\"".'Success adding News Forum'."\");
                                window.location = \"news_forum.php?id=".$id_ruang."\"
                            </script>";
	   		} else {
	   			echo "<script type=\"text/javascript\">
                                alert(\"Failed to add News Forum.\");
                                window.location = \"news_forum.php?id=".$id_ruang."\"
                            </script>";	
	   		}
	   	}  catch(Exception $e){
...
<div id="templatemo_right_column">
    ...
    <div id="templatemo_content">
      <h1>News Forum</h1>
        ...
        <div class="templatemo_wedo">
          <p><h1>Discusion</h1></p>
          <form method="post">
	          <p><input type="text" size="50" name="discusion"></p>
	          <p><h1>Message</h1></p>
	          <p><textarea class="text" cols="86" rows ="20" name="message"></textarea></p>
  ...
  <div id="templatemo_footer">Copyright &copy; 2018 By F****SuryantoNovaldo<!-- Credit: www.templatemo.com --></div>
</div>
