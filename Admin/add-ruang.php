<?php  
    ...
    if(isset($_POST['submit']))
	{
				...
				$result = $db->createRuanganKelas($kode_mk, $nik, $kelas, $semester);
				if($result) {
					echo "<script type=\"text/javascript\">
								alert(\"New Ruangan Inserted. Redirect to Ruangkelas Page.\");
            ...
            <div id="page-inner">
				...
				<form method="post">
					...
					<div class="form-group">
						...
						<input required type="text" class="form-control"  style="width:250px" name="semester" placeholder="semester"/>
					</div>
					<br>
            <input type="submit" name="submit" value="Add Ruang Kelas" />
        </form>
                <!-- /. ROW  -->
                <hr />
			</div>
