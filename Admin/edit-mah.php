<?php  
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = $db->updateMahasiswa($nim, $nama, $email, $pass);        
        if($result) {
            ...
            <div id="page-inner">
				...
				<form method="post">
					...
					<div class="form-group">
						...
						<input required type="text" class="form-control"  style="width:300px" value="<?php echo $data['nama']?>" name="nama" placeholder="Nama Mahasiswa"/>
					</div>
					<br>
                    <div class="form-group">
                        <label>Email Mahasiswa       : </label>
                        <input required type="text" class="form-control"  
                        style="width:300px" value="<?php echo $data['email']?>" name="email" placeholder="Email Mahasiswa"/>
                    </div>
                    <div class="form-group">
